...
/**
 * Controller para operaciones de mantenimiento y control del sistema.
 * Agrupa endpoints para limpieza de datos, control operativo y monitorización.
 */
@RestController
...
public class OperacionesController extends BaseController {
    ...
    @GetMapping("/utilidades/test")
    public ResponseEntity<ApiResponse<Map<String, Object>>> testSimple() {
        logRequest("testSimple");
        ...
        return ok(resultado, "Endpoint de prueba funcionando correctamente");
    }
}
